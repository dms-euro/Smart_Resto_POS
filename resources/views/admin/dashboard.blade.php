        ...
        <div class="flex-1 overflow-y-auto p-6 md:p-8 bg-[#f8f5f2]">
            ...
            <div class="flex flex-wrap items-center justify-between mb-8">
                <div>
                    ...
                    <p class="text-[#8b7a6b] mt-1 flex items-center gap-2"><i
                            class="fa-regular fa-calendar text-[#7aa57a]"></i>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 mb-8">
                ...
                <div
                    ...
                    <div
                        class="w-14 h-14 bg-[#f0ebe6] rounded-full flex items-center justify-center text-3xl text-[#b48b5a]">
                ...
                <div class="bg-white rounded-2xl border border-[#e5d9d0] shadow-sm p-5 flex justify-between items-center">
                    ...
                    <div
                        class="w-14 h-14 bg-[#e9f0e9] rounded-full flex items-center justify-center text-3xl text-[#6f9e6f]">
                ...
                <div class="bg-white rounded-2xl border border-[#e5d9d0] shadow-sm p-5 flex justify-between items-center">
                    ...
                    <div
                        class="w-14 h-14 bg-[#f7ede2] rounded-full flex items-center justify-center text-3xl text-[#b48b5a]">
                ...
                <div class="bg-white rounded-2xl border border-[#e5d9d0] shadow-sm p-5 flex justify-between items-center">
                    ...
                    <div
                        class="w-14 h-14 bg-[#e1f0e1] rounded-full flex items-center justify-center text-3xl text-[#6f9e6f]">
