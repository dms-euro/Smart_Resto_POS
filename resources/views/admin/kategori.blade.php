                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-sm">
                        ...
                        {{ $kategori->icon == 'camilan' ? 'bg-[#f0ebe6] text-[#8e6943]' : '' }}">
                                    ...
                                    <!-- Deskripsi -->
                                    <td class="py-4 px-6 text-gray-600 max-w-md truncate">{{ $kategori->deskripsi ?: '-' }}
                                    </td>

                                    <!-- Jumlah Menu -->
                                    <td class="py-4 px-6">
                                        <span
                                            class="bg-[#f8f5f2] px-3 py-1 rounded-full text-xs font-medium text-[#3d332b]">
                                        ...
                                        <div class="relative bg-white rounded-2xl shadow-lg border border-[#e5d9d0]">
                                            ...
                                            <div class="p-4 md:p-5">
                                                <form action="{{ route('kategori.update', $kategori->id) }}" method="POST"
                                                    ...
                                                    <div>
                                                        <label
                                                            class="block text-sm font-medium text-[#5f4d40] mb-1">Kategori
                                                            Icon</label>
                                                        <div class="relative">
                                                            <select name="icon"
